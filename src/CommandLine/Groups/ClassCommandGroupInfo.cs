...
public sealed class ClassCommandGroupInfo<T> : IClassCommandGroupInfo<T>
	where T : class
{
	#region Properties
	/// <inheritdoc/>
	...
	#region Constructors
	/// <summary>Creates a new instance of the <see cref="ClassCommandGroupInfo{T}"/>.</summary>
